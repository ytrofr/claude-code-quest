...
- **Name-based auto-claim**: `/quest claim --session-name <slug>` now substring-matches the slug against active quest ids before falling back to most-recently-touched. Launch `claude --name apollo` and the quest containing "apollo" gets claimed.
